...
public class XmlReaderContext extends ReaderContext {
	...
	public String generateBeanName(BeanDefinition beanDefinition) {
		/*
			这里的 this.reader.getBeanNameGenerator() 是 DefaultBeanNameGenerator 对象
			这里返回的名称是通过 class.getName，后面拼上 #0，数字如果实例化多个对象，数字递增
			格式：com.mingbao.spring.demo.pojo.UserPojo#0
		 */
